<div id="content-page" class="content group">
	...
	<ul>
		...
		<li class="textarea-field">
			...
			<div class="input-prepend">
				<span class="add-on"><i class="icon-user"></i></span>
				{!! Form::textarea('desc', isset($article->desc) ? $article->desc : old('desc'), ['id' => 'editor', 'placeholder' => 'Введите текст страницы']) !!}
			</div>
		...
		<li class="textarea-field">
			...
			<div class="input-prepend">
				<span class="add-on"><i class="icon-user"></i></span>
				{!! Form::textarea('text', isset($article->text) ? $article->text : old('text'), ['id' => 'editor2', 'placeholder' => 'Введите текст страницы']) !!}
			</div>
			<div class="msg-error"></div>
		</li>
